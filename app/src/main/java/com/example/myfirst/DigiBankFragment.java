...
public class DigiBankFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_digi_bank, container, false);

        if(savedInstanceState == null){
            Bundle b = new Bundle();
            b.putString("bankNameAbout","digibank");
            aboutSavBankFragment= new AboutSavBankFragment();
            aboutSavBankFragment.setArguments(b);

            getChildFragmentManager().beginTransaction().replace(R.id.digibank_savings_bank_details_functions_details_relative,aboutSavBankFragment).commit();

        }else {

            getChildFragmentManager().beginTransaction().replace(R.id.digibank_savings_bank_details_functions_details_relative, fragment).commit();

        }

        aboutBtn = view.findViewById(R.id.digibank_about_txt_btn);
        docReqBtn = view.findViewById(R.id.digibank_document_req_txt_btn);
        prodFeatureBtn = view.findViewById(R.id.digibank_prod_features_txt_btn);
        bankLocateBtn = view.findViewById(R.id.digibank_bank_location_txt_btn);
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.digibank_about_txt_btn){
        ...
        if(view.getId()==R.id.digibank_document_req_txt_btn){
            ...
            bankLocateBtn.setTextColor(getResources().getColor(android.R.color.black));
            Bundle b = new Bundle();
            b.putString("bankName","digibank");
            fragment.setArguments(b);

        }
        if(view.getId()==R.id.digibank_prod_features_txt_btn){
        ...
        if(view.getId()==R.id.digibank_bank_location_txt_btn){
